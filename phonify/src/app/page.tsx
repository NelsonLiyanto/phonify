    ...
    <main className="flex-1 flex flex-col bg-white">
      ...
      >
        <div className="flex flex-col w-screen bg-black items-center justify-center">
          <img
            src="https://radarbanyumas.disway.id/upload/f8888e446ec1b44206bb5930c6d404f6.jpg"
            alt=""
      ...
      {/* --- */}
      <section
        id="page-categories-nav"
        className="flex flex-col items-center bg-yellow-400"
      >
        <div
          className="flex-1 p-2 flex gap-2 md:justify-center"
          id="page-categories-nav"
        >
          ...
          <button className="btn bg-red-500 border-none text-white">New</button>
        </div>
      </section>
      <section id="newest-items">
        ...
        <div className="flex justify-center">
          <Link href={""} className="px-10 py-5 text-red-500 text-xl">
            {"See all"}
          </Link>
        </div>
      </section>
